function diss = dissAMD(~, ~, ~, I1, I2, I3, I4)

% DESCRIPTION %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Compute the reduced dissipation of kinetic energy of the isotropized version 
% of the anisotropic minimum-dissipation model.
%
% INPUT %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
if fact > 0
    ...
    diss = 2 * I1 * feval('nueAMD', [], [], [], I1, I2, I3, I4);
else
