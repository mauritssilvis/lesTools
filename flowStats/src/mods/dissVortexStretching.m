function diss = dissVortexStretching(~, ~, ~, I1, I2, ~, ~, I5)

% DESCRIPTION %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Compute the reduced dissipation of kinetic energy of the vortex-stretching-
...
if fact > 0
    ...
    diss = 2 * I1 * feval('nueVortexStretching', ...
        [], [], [], I1, I2, [], [], I5);
else
